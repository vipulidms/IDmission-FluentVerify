...
export default function AdminAddUserModal({ onClose, onSuccess }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.6)", backdropFilter: "blur(4px)", padding: "16px" }}>
      <div className="glass-card animate-scaleIn" style={{ width: "100%", maxWidth: "680px", maxHeight: "calc(100vh - 32px)", padding: "32px", position: "relative", display: "flex", flexDirection: "column" }}>
        ...
        <h2 style={{ fontSize: "24px", fontWeight: 800, marginBottom: "24px", flexShrink: 0 }}>Add Candidate</h2>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px", flexGrow: 1, overflow: "hidden" }}>
          ...
          <button type="submit" className="btn btn-primary" disabled={loading} style={{ width: "100%", padding: "14px", marginTop: "8px", flexShrink: 0 }}>
